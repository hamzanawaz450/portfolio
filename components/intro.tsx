...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      <motion.h1
        className="mb-10 mt-4 px-4 text-2xl font-medium !leading-[1.5] sm:text-4xl text-[#9CA3AF]"
      ...
      >
        <Link
          href="#contact"
          className="bg-[#0e79b2] group bg-gray-900 text-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-105 transition"
          onClick={() => {
        ...
        <a
          ...
          href="https://www.linkedin.com/in/hamza-nawaz-8b7204282/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
